...
class MealCategoryCardLoaderComponent extends StatelessWidget {

  MealCategoryCardLoaderComponent({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 36,
      padding: EdgeInsets.symmetric(vertical: APPSTYLE_SpaceSmall,horizontal: APPSTYLE_SpaceLarge),

...
class MealCategoryCardComponent extends StatelessWidget {
  bool isSelected;
  String label;
  GestureTapCallback onClick;

  MealCategoryCardComponent({super.key, required this.isSelected, required this.label, required this.onClick});

...
class MealsDetailsPage_Auth extends StatefulWidget {
  const MealsDetailsPage_Auth({super.key});

  @override
  State<MealsDetailsPage_Auth> createState() => _MealsDetailsPage_AuthState();
}

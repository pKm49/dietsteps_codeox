 import 'package:dietsteps/feature_modules/address/controllers/address.controller.dart';
import 'package:dietsteps/feature_modules/address/models/shipping_address.model.address.dart';
 import 'package:dietsteps/feature_modules/address/ui/components/address_card.component.address.dart';
import 'package:dietsteps/feature_modules/e_shop/controllers/controller.eshop.dart';
import 'package:dietsteps/feature_modules/e_shop/ui/components/address_card.component.eshop.dart';
...
import 'package:dietsteps/shared_module/ui/components/dropdown_selector.component.shared.dart';
...
class AddressSelect_Eshop extends StatefulWidget {
  ...
  @override
  State<AddressSelect_Eshop> createState() =>
      _AddressSelect_EshopState();
}

class _AddressSelect_EshopState
    extends State<AddressSelect_Eshop> {
          ...
          body: SafeArea(
            child: Obx(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return AddressCardComponentEshop(
                                ...
                                onSelected: () {
                                  addressController.changeAddressId(addressController.customerAddressList[index].id) ;
                                },
                ...
                Visibility(
                    ...
                    Visibility(
                      visible: addressController.addressId.value != -1,
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text('delivery_time'.tr,
                                style: getHeadlineMediumStyle(context)),
                            Text( getDeliveryTimeOfSelectedAddress(),
                                style: getHeadlineMediumStyle(context))
                          ],),
                      ),
                    ),
                    Visibility(
                      visible:!addressController.isCustomerAddressListFetching.value &&  addressController.customerAddressList.isNotEmpty ,
                      child: Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              if(!addressController.isAddingToOrRemoveFromCart.value){
                                if(addressController.addressId.value !=-1 ){

                                  addressController.createCart();
                                }else{
                                  if(addressController.addressId.value ==-1  ){
                                    showSnackbar(context, "please_select_address".tr, "info");
                                  }else{
                                    showSnackbar(context, "please_select_time".tr, "info");
                                  }
                                }
                              }
                            ...
                            child: addressController.isAddingToOrRemoveFromCart.value
  ...
  getDeliveryTimeOfSelectedAddress(){
    List<Address> tAddress = addressController.customerAddressList.where((p0) => p0.id== getSelectedAddress()).toList();
    if(tAddress.isNotEmpty){
      return tAddress[0].eShopDeliveryTime;
    }else{
      return "";
    }
  }
